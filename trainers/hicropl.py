...
class CrossModalPromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        assert cfg.TRAINER.HICROPL.PROMPT_DEPTH >= 1, "In HiCroPL prompting, prompt depth should be >=1" \
        ...
        cross_prompts_visual = nn.ParameterList([nn.Parameter(visual_vectors.clone()) for _ in range(self.cross_prompts_depth)])
